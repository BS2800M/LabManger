...
CREATE TABLE "new_Location" (
    ...
    "MaxTemperature" INTEGER NOT NULL DEFAULT -50,
    "MinTemperature" INTEGER NOT NULL DEFAULT -50,
    "MaxHumidity" INTEGER NOT NULL DEFAULT 100,
    "MinHumidity" INTEGER NOT NULL DEFAULT 100,
