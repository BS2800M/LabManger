...
export let api_location_show=(params)=>{
    return myrequest.get('/location/show',{
        name:params.name,
        page:params.page,
...
export let api_location_del=(id)=>{
    return myrequest.put('/location/del',{
        id:id
    })
}

export let api_location_update=(body)=>{
    return myrequest.put('/location/update',{
        id:body.id,
        name:body.name,
        note:body.note,
...
export let api_location_add=(body)=>{
    return myrequest.post('/location/add',{
        name:body.name,
        note:body.note,
        uploadIntervalMinutes:body.uploadIntervalMinutes,
        maxTemperature:body.maxTemperature,
...
export let api_location_showAll=()=>{
    return myrequest.get('/location/showAll',{
    })
}