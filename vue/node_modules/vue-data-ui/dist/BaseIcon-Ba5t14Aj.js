...
import { X as l } from "./index-BLtEpj8j.js";
...
const M = ["xmlns", "viewBox", "height", "width", "innerHTML"], h = {
  ...
  setup(o) {
    const t = o, r = e(() => t.name === "numbers" ? "0 0 20 21" : "0 0 20 20"), s = e(() => ({
      ...
      trash: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 7 18 L 13 18 C 15 18 15 18 16 6 L 16 6 L 5 6 L 4 6 C 5 18 5 18 7 18 M 3 4 L 17 4 M 8 2 L 12 2 M 10 8 L 10 15 M 7 8 L 7.518 15.01 M 13 8 L 12.454 14.984" />`,
      palette: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" d="M 10 2 A 1 1 0 0 0 10 18 C 10 18 14 18 14 16 C 14 13 12 14 11 13 C 10 10 14 11 15 11 C 20 11 19 2 10 2 M 6 6 A 1 1 0 0 0 8 8 A 1 1 0 0 0 6 6 M 6 11 A 1 1 0 0 0 8 13 A 1 1 0 0 0 6 11 M 11 5 A 1 1 0 0 0 13 7 A 1 1 0 0 0 11 5"/>`,
      colorPicker: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" d="M3 17 4 13 11.759 5.267 15.265 9.324 7 17 3 17M12.35 3.14 17.47 9.206M14.438 3.062C18.298 2.432 18.77 4.716 17.864 7.079"/>`,
      boxes: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" d="M10 11 6 9 2 11 2 16 6 18 10 16 10 11M10 11 14 9 18 11 18 16 14 18 10 16M6 9 6 4 10 2 14 4 14 9M6 4 10 6 14 4M2 11 6 13 10 11M10 11 14 13 18 11M10 6 10 11M6 13 6 18M14 13 14 18"/><path fill="${t.stroke}" stroke="none" style="opacity:0.5" d="M 6 4 L 10 6 L 10 11 L 6 9 L 6 4"/><path fill="${t.stroke}" stroke="none" style="opacity:0.5" d="M 2 11 L 6 13 L 6 18 L 2 16 L 2 11"/><path fill="${t.stroke}" stroke="none" style="opacity:0.5" d="M 10 11 L 14 13 L 14 18 L 10 16 L 10 11"/>`,
      chartFunnel: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 9 18 C 10 19 11 18 11 18 L 12 10 L 18 5 L 18 3 C 18 3 18 2 17 2 L 3 2 C 3 2 2 2 2 3 L 2 5 L 8 10 L 9 18 M 4 4 C 7 6 13 6 16 4"/>`,
      chartHistoryPlot: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" d="M 4 4 A 1 1 0 0 0 6 4 A 1 1 0 0 0 4 4 M 12 2 A 1 1 0 0 0 12 4 A 1 1 0 0 0 12 2 M 17 7 A 1 1 0 0 0 17 9 A 1 1 0 0 0 17 7 M 12 14 A 1 1 0 0 0 12 16 A 1 1 0 0 0 12 14 M 5 12 A 1 1 0 0 0 5 14 A 1 1 0 0 0 5 12 M 6 4 L 11 3 M 12.84 3.582 L 16.267 7.265 M 16.625 8.953 L 12.763 14.297 M 10.999 14.732 L 5.987 13.326 M 1 1 L 1 19 L 19 19"/>`,
      chartTableSparkline: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 1 1 L 7 1 L 7 5 L 1 5 L 1 1 M 1 8 L 7 8 L 7 12 L 1 12 L 1 8 M 1 15 L 7 15 L 7 19 L 1 19 L 1 15 M 9 3 C 9.3333 2.3333 9.261 1.027 10 1 C 11 2 10.139 4.975 11.421 5.009 C 12.231 5.009 12 3 13 3 C 14 4 14.053 4.03 14 4 C 16 4 16 1 17 1 C 18 1 18 3 19 3 M 9 12 C 9.3333 11 9.126 9.531 10 9 C 11 9 11 11 11.759 11.084 C 12.771 10.915 12.231 8.012 13.21 8.012 C 14.29 7.945 14 12 15 12 C 16 12 16 10 17 10 C 18 10 18 11 19 11 M 9 16 C 9.6667 17 9.734 18.981 10.645 19.048 C 11.691 18.609 11.117 14.965 12 15 C 13 15 12.636 17.158 13.682 17.293 C 15 17 14 15 15 15 C 16 15 16 19 17 19 C 18 19 18 15 19 15" />`,
      chartCirclePack: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 10 7 A 1 1 0 0 0 10 13 A 1 1 0 0 0 10 7 M 5 5 A 1 1 0 0 0 7.716 8.039 A 1 1 0 0 0 5 5 M 13 4 A 1 1 0 0 0 11.354 7.322 A 1 1 0 0 0 13 4 M 8.506 12.628 A 1 1 0 0 0 5.05 16.755 A 1 1 0 0 0 8.506 12.628 M 14.965 6.988 A 1 1 0 0 0 13.535 9.758 A 1 1 0 0 0 14.965 6.988 M 16 11 A 1 1 0 0 0 13.084 14.742 A 1 1 0 0 0 16 11"/>`,
      home: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 2 10 L 10 2 L 18 10 M 4 10 L 4 17 C 4 18 4 18 5 18 L 8 18 L 8 12 L 12 12 L 12 18 L 15 18 C 16 18 16 18 16 17 L 16 10 M 8 18"/>`,
      homeFilled: `<path fill="${t.stroke}" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 2 10 L 10 2 L 18 10 M 4 10 L 4 17 C 4 18 4 18 5 18 L 8 18 L 8 12 L 12 12 L 12 18 L 15 18 C 16 18 16 18 16 17 L 16 10 M 8 18"/>`,
      icons: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 1 9 L 5 2 L 9 9 L 1 9 M 12 9 L 12 2 L 19 2 L 19 9 L 12 9 M 5 11 C 0 11 0 18 5 18 C 10 18 10 11 5 11 M 15 11 L 15 18 L 16 18 L 16 11 L 15 11 M 12 14 L 19 14 L 19 15 L 12 15 L 12 14"/>`,
      robot: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 2 2 L 18 2 L 18 18 L 2 18 L 2 2 M 6 5 A 1 1 0 0 0 6 8 A 1 1 0 0 0 6 5 M 14 5 A 1 1 0 0 0 14 8 A 1 1 0 0 0 14 5 M 1 4 L 1 9 M 19 4 L 19 9 M 5 11 C 6 16 14 16 15 11 M 7 1 L 13 1"/>`,
      hourglass: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 4 1 L 16 1 M 13 1 C 16 3 14 5 14 5 M 7 1 C 4 3 6 5 6 5 M 4 19 L 16 19 M 6 5 C 10 10 10 10 6 15 M 14 5 C 10 10 10 10 14 15 M 13 19 C 16 17 14 15 14 15 M 7 19 C 4 17 6 15 6 15"/><path style="opacity:0.3" fill="${t.stroke}" stroke="none" d="M 7 18 L 13 18 C 14 15 11 13 10 13 C 9 13 6 15 7 18"/>`,
      computer: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 2 4 L 2 10 C 2 11 3 12 4 12 L 16 12 C 17 12 18 11 18 10 L 18 4 C 18 3 17 2 16 2 L 4 2 C 3 2 2 3 2 4 M 4 16 L 2 19 L 18 19 L 16 16 L 4 16 M 5 14 L 15 14 M 7 14 L 10 12 L 13 14 M 7 5 L 4 7 L 7 9 M 13 5 L 16 7 L 13 9 M 11 4 L 9 10"/>`,
      htmlTag: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 6 5 L 1 10 L 6 15 M 14 5 L 19 10 L 14 15 M 7 18 L 13 2"/>`,
      curlyBrackets: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 5 2 C 3 2 2 3 2 5 L 2.35 7.988 C 2 9 1 9 1 10 C 1 11 2 11 2.396 11.949 L 2 15 C 2 17 3 18 5 18 M 15 2 C 17 2 18 3 18 5 L 17.611 8.035 C 18 9 19 9 19 10 C 19 11 18 11 17.611 12.008 L 18 15 C 18 17 17 18 15 18"/>`,
      curlySpread: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 5 2 C 3 2 2 3 2 5 L 2.35 7.988 C 2 9 1 9 1 10 C 1 11 2 11 2.396 11.949 L 2 15 C 2 17 3 18 5 18 M 15 2 C 17 2 18 3 18 5 L 17.611 8.035 C 18 9 19 9 19 10 C 19 11 18 11 17.611 12.008 L 18 15 C 18 17 17 18 15 18 M 10 9 A 1 1 0 0 0 10 11 A 1 1 0 0 0 10 9 M 6 9 A 1 1 0 0 0 6 11 A 1 1 0 0 0 6 9 M 14 9 A 1 1 0 0 0 14 11 A 1 1 0 0 0 14 9"/>`,
      text: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 2 2 L 12 2 L 12 4 L 8 4 L 8 18 L 6 18 L 6 4 L 2 4 L 2 2 M 12 15 L 18 15 M 12 7 L 18 7 M 12 11 L 18 11"/>`,
      world: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 10 1 A 1 1 0 0 0 10 19 A 1 1 0 0 0 10 1 C 3 4 3 16 10 19 M 10 1 C 17 4 17 16 10 19 M 10 1 L 10 19 M 1 10 L 19 10 M 1 10"/>`,
      eye: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 1 10 Q 10 1 19 10 Q 10 19 1 10 M 10 7 A 1 1 0 0 0 10 13 A 1 1 0 0 0 10 7 M 10 9 A 1 1 0 0 0 10 11 A 1 1 0 0 0 10 9"/>`,
      chartRidgeline: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 1 15 L 4 16 L 7 14 L 10 18 L 14 10 L 17 16 L 19 15 M 1 12 L 6 11 L 10 12 L 14 6 M 14 6 L 17 11 L 19 12 M 1 9 L 6 8 L 9 8 L 14 1 L 17 6 L 19 6"/>`,
      chartChord: `<path fill="none" stroke="${t.stroke}" stroke-width="${t.strokeWidth}" stroke-linecap="round" stroke-linejoin="round" d="M 9 1 Q 2 2 1 9 M 1 11 Q 2 18 9 19 M 11 19 Q 18 18 19 11 M 19 9 Q 18 2 11 1 M 5.683 2.021 C 9 6 13 4 14.893 2.322 M 2.421 4.987 C 14.469 7.137 15.545 12.216 17.361 15.33 M 4.83 17.48 C 9.02 13.773 11.207 14.218 15.433 17.369 M 1.976 14.033 C 11.207 12.735 15.952 9.065 17.213 4.393"/>`
    }));
    return (a, C) => (i(), n("svg", {
      xmlns: L(l),
      class: k({ "spin ": o.isSpin }),
      viewBox: r.value,
      height: o.size,
      width: o.size,
      innerHTML: s.value[o.name],
      style: { background: "transparent" }
    }, null, 10, M));
  }
}, u = /* @__PURE__ */ d(h, [["__scopeId", "data-v-5152c3a6"]]);
export {
  u as default
};
