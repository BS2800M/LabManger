import { computed as t, createElementBlock as z, openBlock as c, createElementVNode as h } from "vue";
function L() {
  return {
    ...{
      bubbles: {
...
const i = ["id", "height", "width", "patternTransform"], s = ["fill"], r = ["fill", "stroke", "stroke-width", "stroke-linecap", "d"], M = {
  ...
  setup(m) {
    const a = m, e = L(), l = t(() => e[a.name]);
    return (n, v) => (c(), z("pattern", {
      id: m.id,
