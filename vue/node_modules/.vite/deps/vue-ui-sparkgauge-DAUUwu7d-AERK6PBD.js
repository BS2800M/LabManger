...
var fe = {
  ...
  setup(E) {
    const F = defineAsyncComponent(() => import("./PackageVersion-CnRyWKP--A4MFJVN6.js")), B = defineAsyncComponent(() => import("./vue-ui-skeleton-CsMU8DwQ-52RP5HSI.js")), { vue_ui_sparkgauge: D } = pr(), a = E, p = computed(() => !!a.dataset && Object.keys(a.dataset).length);
    onMounted(() => {
      h();
    });
    function h() {
...
//# sourceMappingURL=vue-ui-sparkgauge-DAUUwu7d-AERK6PBD.js.map
