...
// node_modules/vue-data-ui/dist/vue-ui-kpi-CgRnp_cJ.js
var G = {
  __name: "vue-ui-kpi",
  props: {
    config: {
  ...
  setup(o) {
    const F = defineAsyncComponent(() => import("./vue-ui-digits-DOcvXxeY-322A4RSO.js")), { vue_ui_kpi: N } = pr(), l = o, e = computed({
      get: () => c2(),
      set: (a) => a
    }), D = useSlots();
    onMounted(() => {
    ...
    const S = ref((typeof l.dataset == "number", l.dataset)), t = ref(e.value.useAnimation ? e.value.animationValueStart : S.value), m = (a) => {
    ...
    return watch(() => l.dataset, (a) => {
      ...
      createBaseVNode("div", {
        ...
        e.value.analogDigits.show ? (openBlock(), createElementBlock("div", {
          ...
          createTextVNode(toDisplayString(unref(Re)(
            e.value.formatter,
            t.value,
            unref(Ae)({
              p: e.value.prefix,
...
//# sourceMappingURL=vue-ui-kpi-CgRnp_cJ-BHQJ74OF.js.map
