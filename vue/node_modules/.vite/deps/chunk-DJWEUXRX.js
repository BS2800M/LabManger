...
// node_modules/vue-data-ui/dist/vue-ui-accordion-B6Svdk-2.js
var F = ["id"];
var P = {
  key: 0,
...
var z = {
  ...
  setup(l) {
    ...
    const { vue_ui_accordion: f } = pr(), g = l, e = computed(() => c({
      userConfig: g.config,
      defaultConfig: f
    })), a = ref(e.value.open), h = ref(ee()), t = ref(null), d = ref(0);
    onMounted(() => {
...
//# sourceMappingURL=chunk-DJWEUXRX.js.map
