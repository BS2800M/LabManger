...
// node_modules/vue-data-ui/dist/vue-ui-digits-DOcvXxeY.js
var w = { key: 0 };
var B = ["d", "fill"];
var F = ["d", "fill"];
var X = ["d", "fill"];
  ...
  setup(e) {
    const c2 = e, u = ref({
      ...
      */
      ...
      "-": "0000001",
      X: "0000000"
    }), t = computed(() => [void 0, null].includes(c2.quanta) ? u.value.X : u.value[c2.quanta]);
...
var U = {
  ...
  setup(e) {
    const { vue_ui_digits: c2 } = pr(), u = e, t = computed(() => c({
      userConfig: u.config,
      defaultConfig: c2
    })), y = computed(() => {
...
//# sourceMappingURL=vue-ui-digits-DOcvXxeY-ZSL7M65M.js.map
