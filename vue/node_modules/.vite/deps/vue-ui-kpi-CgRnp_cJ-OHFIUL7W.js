...
var G = {
  ...
  setup(o) {
    const F = defineAsyncComponent(() => import("./vue-ui-digits-DOcvXxeY-ZSL7M65M.js")), { vue_ui_kpi: N } = pr(), l = o, e = computed({
      get: () => c2(),
      set: (a) => a
    }), D = useSlots();
    onMounted(() => {
...
//# sourceMappingURL=vue-ui-kpi-CgRnp_cJ-OHFIUL7W.js.map
