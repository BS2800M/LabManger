...
var Se = {
  ...
  setup(C, { emit: M }) {
    const U = defineAsyncComponent(() => import("./PackageVersion-CnRyWKP--A4MFJVN6.js")), j = defineAsyncComponent(() => import("./vue-ui-skeleton-CsMU8DwQ-52RP5HSI.js")), { vue_ui_sparkbar: G } = pr(), a = C, W = useSlots();
    onMounted(() => {
...
//# sourceMappingURL=vue-ui-sparkbar-A_U6AgV--NCMCEZER.js.map
