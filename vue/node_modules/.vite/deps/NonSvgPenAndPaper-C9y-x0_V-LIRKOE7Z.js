import {
  M
} from "./chunk-2DLTC2QL.js";
import "./chunk-BO4DXGQY.js";
import {
  u
...
// node_modules/vue-data-ui/dist/NonSvgPenAndPaper-C9y-x0_V.js
var Te = {
...
var De = ["disabled"];
var Ne = ["data-mode", "xmlns", "viewBox"];
var Me = ["cx", "cy", "r", "fill"];
var Le = ["d", "stroke", "stroke-width"];
var Fe = ["x", "y", "fill", "font-size"];
var Pe = ["x", "dy"];
var ze = ["d", "stroke", "stroke-width"];
var Xe = {
  ...
  emits: ["close"],
  setup(u2, { emit: ve }) {
    const $ = u2, de = ve, w = ref([]), N = ref([]), G = ref("0 0 0 0"), S = ref($.color), L = ref(1), m = ref("draw"), c = ref(null), V = ref(false), p = ref(null), F = ref({ x: 0, y: 0 }), A = ref([""]), P = ref({ row: 0, col: 0 }), E = ref(16);
    let pe = 1;
    function I() {
      return pe++;
    }
    ...
    function Q(l) {
      ...
      o.setAttribute("x", e), o.setAttribute("dy", "0"), o.textContent = "", n.appendChild(o), n.style.pointerEvents = "none", n.style.userSelect = "none", c.value.appendChild(n), p.value = n, V.value = true, window.addEventListener("keydown", H), window.addEventListener("mousedown", J, true), O(), j();
    }
    function H(l) {
      if (!V.value) return;
      let { row: e, col: t } = P.value, n = A.value.slice(), o = false;
      if (l.key === "Enter") {
        const a = n[e], r = a.slice(0, t), v = a.slice(t);
        n.splice(e, 1, r, v), e += 1, t = 0, o = true, l.preventDefault();
      } else if (l.key === "Backspace") {
        if (t > 0)
          n[e] = n[e].slice(0, t - 1) + n[e].slice(t), t -= 1, o = true;
        else if (e > 0) {
          const a = n[e - 1].length;
          n[e - 1] += n[e], n.splice(e, 1), e -= 1, t = a, o = true;
        }
        l.preventDefault();
      } else if (l.key === "Delete")
        t < n[e].length ? (n[e] = n[e].slice(0, t) + n[e].slice(t + 1), o = true) : e < n.length - 1 && (n[e] += n[e + 1], n.splice(e + 1, 1), o = true), l.preventDefault();
      else if (l.key === "ArrowLeft")
        t > 0 ? t -= 1 : e > 0 && (e -= 1, t = n[e].length), o = true, l.preventDefault();
      else if (l.key === "ArrowRight")
        t < n[e].length ? t += 1 : e < n.length - 1 && (e += 1, t = 0), o = true, l.preventDefault();
      else if (l.key === "ArrowUp")
        e > 0 && (e -= 1, t = Math.min(t, n[e].length), o = true), l.preventDefault();
      else if (l.key === "ArrowDown")
        e < n.length - 1 && (e += 1, t = Math.min(t, n[e].length), o = true), l.preventDefault();
      else if (l.key.length === 1 && !l.ctrlKey && !l.metaKey && !l.altKey)
        n[e] = n[e].slice(0, t) + l.key + n[e].slice(t), t += 1, o = true, l.preventDefault();
    ...
    function j() {
      ...
      s2.setAttribute("x", t), s2.setAttribute("y", n), s2.setAttribute("font-size", r), s2.setAttribute("font-family", "sans-serif"), s2.textContent = d || "", c.value.appendChild(s2);
      const f = s2.getBBox();
      c.value.removeChild(s2);
    ...
    function J(l) {
      if (p.value && !p.value.contains(l.target)) {
        ...
        e.length === 1 && (e[0].textContent === "" || e[0].textContent === "​") && p.value.remove(), Z(false);
      }
    }
    function Z(l = false) {
      window.removeEventListener("keydown", H), window.removeEventListener("mousedown", J, true);
      ...
      }), p.value && c.value && c.value.contains(p.value) && c.value.removeChild(p.value), V.value = false, p.value = null, A.value = [""], P.value = { row: 0, col: 0 };
    }
    const B = computed(() => Rt($.color, 0.6));
    ...
    const z = ref(false), X = ref(""), k = ref(null);
    function _(l) {
    ...
    function te(l) {
      ...
      for (let v = 2; v < n.length - 2; v += 2) {
        const d = n[v - 2], s2 = n[v - 1], f = n[v], h = n[v + 1], T = (d + f) / 2, g = (s2 + h) / 2;
        o.push(`Q ${d} ${s2} ${T} ${g}`);
      }
    ...
    function he(l, e = 1) {
      ...
      for (let n = 2; n < l.length - 2; n += 2) {
        const o = l[n], a = l[n + 1], r = l[n - 2], v = l[n - 1], d = l[n + 2], s2 = l[n + 3];
        t[n] = o + e * ((r + d) / 2 - o), t[n + 1] = a + e * ((v + s2) / 2 - a);
      }
      return t;
    }
    function ge(l) {
      ...
      for (let r = 0; r < e.length; r += 1) {
        ...
        if (isNaN(v)) {
          if (n = v, n === "M" || n === "L")
            ...
            const d = parseFloat(e[++r]), s2 = parseFloat(e[++r]), f = parseFloat(e[++r]), h = parseFloat(e[++r]);
            d === o && s2 === a ? t += `t${f - o} ${h - a}` : t += `q${d - o} ${s2 - a} ${f - o} ${h - a}`, o = f, a = h;
          }
        } else {
          const d = parseFloat(v), s2 = parseFloat(e[++r]);
          if (n === "L") {
            const f = d - o, h = s2 - a;
            f === 0 ? t += `v${h}` : h === 0 ? t += `h${f}` : t += `l${f} ${h}`, o = d, a = s2;
          } else if (n === "Q") {
            const f = d, h = s2, T = parseFloat(e[++r]), g = parseFloat(e[++r]);
    ...
    return (l, e) => (openBlock(), createElementBlock(Fragment, null, [
      u2.active ? (openBlock(), createElementBlock("div", {
        key: 0,
        ...
        style: normalizeStyle({ backgroundColor: u2.backgroundColor })
      }, [
        createBaseVNode("button", {
          class: "vue-ui-pen-and-paper-action",
          style: normalizeStyle({
            backgroundColor: u2.backgroundColor,
        ...
        createBaseVNode("button", {
          class: normalizeClass(["vue-ui-pen-and-paper-action", { "vue-ui-pen-and-paper-action-active": m.value === "text" }]),
        ...
        m.value === "draw" ? withDirectives((openBlock(), createElementBlock("input", {
          key: 0,
          ref_key: "range",
          ref: le,
          type: "range",
          ...
          style: normalizeStyle({ accentColor: u2.color })
        }, null, 4)), [
          [vModelText, L.value]
        ]) : createCommentVNode("", true),
        m.value === "text" ? withDirectives((openBlock(), createElementBlock("input", {
          key: 1,
          ref_key: "range",
          ref: le,
          type: "range",
      ...
      (openBlock(), createElementBlock("svg", {
        ...
        onMouseup: K,
        onMouseleave: K,
        onTouchstart: withModifiers(_, ["prevent"]),
        onTouchmove: withModifiers(ee, ["prevent"]),
        onTouchend: K
      }, [
        createBaseVNode("g", {
          ref_key: "G",
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(w.value, (t) => (openBlock(), createElementBlock(Fragment, {
            key: t.id
          }, [
            t.path && t.path.replace("M", "").split(" ").length === 2 ? (openBlock(), createElementBlock("circle", {
              key: 0,
              cx: t.path.replace("M", "").split(" ")[0],
              cy: t.path.replace("M", "").split(" ")[1],
              r: t.strokeWidth / 2,
              fill: t.color
            }, null, 8, Me)) : t.path ? (openBlock(), createElementBlock("path", {
              key: 1,
              ...
              fill: "none"
            }, null, 8, Le)) : t.type === "text" ? (openBlock(), createElementBlock("text", {
              key: 2,
              x: t.x,
              y: t.y,
              fill: t.color,
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(t.lines, (n, o) => (openBlock(), createElementBlock("tspan", {
                key: o,
                x: t.x,
                dy: o === 0 ? "0" : t.fontSize * 1.2
              }, toDisplayString(n.length ? n : "​"), 9, Pe))), 128))
            ], 8, Fe)) : createCommentVNode("", true)
          ], 64))), 128))
        ], 512),
        z.value ? (openBlock(), createElementBlock("path", {
          key: 0,
...
var We = s(Xe, [["__scopeId", "data-v-14478ba4"]]);
export {
  We as default
};
//# sourceMappingURL=NonSvgPenAndPaper-C9y-x0_V-LIRKOE7Z.js.map
