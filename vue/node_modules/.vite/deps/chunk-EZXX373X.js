...
var ht = {
  ...
  components: {
    ...
    // Must be ready in responsive mode
    Shape: h,
    DataTable: defineAsyncComponent(() => import("./DataTable-CS_V_Adx-A2K7AOHO.js")),
    Tooltip: defineAsyncComponent(() => import("./Tooltip-CuHsd1IQ-R3L24RZE.js")),
    UserOptions: defineAsyncComponent(() => import("./UserOptions-DGw0HvSp-HRCLJUQP.js")),
    BaseIcon: defineAsyncComponent(() => import("./BaseIcon-Ba5t14Aj-F5KM7UAA.js")),
    TableSparkline: defineAsyncComponent(() => import("./vue-ui-table-sparkline-CmYu64QM-FGGDAQOB.js")),
    Skeleton: defineAsyncComponent(() => import("./vue-ui-skeleton-CsMU8DwQ-52RP5HSI.js")),
    Accordion: defineAsyncComponent(() => import("./vue-ui-accordion-B6Svdk-2-KBQM2CRD.js")),
    PackageVersion: defineAsyncComponent(() => import("./PackageVersion-CnRyWKP--A4MFJVN6.js")),
    PenAndPaper: defineAsyncComponent(() => import("./PenAndPaper-7BWf7zgA-UDLXNXD5.js"))
  },
  data() {
...
'${c2}' was converted to null to allow the chart to display.`);
    ...
    async generatePdf() {
      this.showSpinnerPdf(), clearTimeout(this.__to__), this.isPrinting = true, this.__to__ = setTimeout(async () => {
        try {
          const { default: r } = await import("./pdf-BcZrdj8V-3GRAHGN3.js");
          await r({
    ...
    async generateImage() {
      this.showSpinnerImage(), clearTimeout(this.__to__), this.isImaging = true, this.__to__ = setTimeout(async () => {
        try {
          const { default: r } = await import("./img-D-vWHxhM-7JBSLW7B.js");
          await r({
            domElement: document.getElementById(`vue-ui-xy_${this.uniqueId}`),
            fileName: this.FINAL_CONFIG.chart.title.text || "vue-ui-xy",
            format: "png",
...
//# sourceMappingURL=chunk-EZXX373X.js.map
